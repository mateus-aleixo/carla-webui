import carla
from classes.agents.Aggressive import Aggressive
from classes.agents.BasicAgent import BasicAgent
from classes.agents.Cautious import Cautious
from classes.agents.Normal import Normal
from classes.RoadOption import RoadOption
from functions.auxiliary_functions import get_speed, positive
import numpy as np
...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(
        self, vehicle, behavior="normal", opt_dict={}, map_inst=None, grp_inst=None
    ):
        """
        Constructor method.
